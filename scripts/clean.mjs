...
const paths = [
  ...
  "packages/db-performance/dist",
  "packages/db-performance/tsconfig.tsbuildinfo",
  "packages/performance-tests/dist",
  "packages/performance-tests/tsconfig.tsbuildinfo",
